...
export function parseCliArgs(argv: string[]): {
  ...
  if (argv[2] === "summary") {
    return { ...defaults, runSummary: true };
  }
  if (argv[2] === "history") {
...
commands:
  ...
  summary        one-line fleet status (for shell prompts, tmux status bars)
